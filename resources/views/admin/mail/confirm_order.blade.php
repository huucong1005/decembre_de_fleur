...
<body>
	...
	<div class="container" style="background-color: #dff2d3; border-radius: 15px; padding: 20px;">
		<div class="col-md-12">
			<div class="col-md-6" style="text-align: center;   font-weight: bold;font-size: 30px;">
				...
				<h6 style="margin: 0;"> Xác nhận đơn đặt hàng</h6>
			</div>
			...
			<div class="col-md-12">
				...
				<h4 style="text-transform: uppercase;">
					<p><span style="color: #0e9131; font-size: 20px;">&#10004;</span> Đơn hàng này đã được cửa hàng chúng tôi xác nhận</p>
				</h4>
