                        ...
                        @foreach($edit_brand as $key =>$edit_value)
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="brand_name" class="form-control" id="slug" onkeyup="ChangeToSlug();" value="{{$edit_value->brand_name}}"  required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Slug</label>
                                    <input type="text" name="brand_slug" class="form-control" id="convert_slug" value="{{$edit_value->brand_slug}}">
                                </div>
                                <div class="form-group">
